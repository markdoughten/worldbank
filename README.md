# About
A forecasting package for World Bank indicators. Here are a couple figures generated with the corresponding command. If you are not sure, run generate.sh for a randomly generated command.  
